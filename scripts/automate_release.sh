...
See release notes: https://github.com/akardas16/google-mlkit-swiftpm/releases/tag/$VERSION"
...
echo ""
echo "Release URL:"
echo "https://github.com/akardas16/google-mlkit-swiftpm/releases/tag/$VERSION"
echo ""
